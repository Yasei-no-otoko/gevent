...
| `/luma-connpass-event` | Create Luma and connpass event drafts from event details and a timetable using logged-in browser sessions. |
...
| `/luma-connpass-event` | Fill Luma and connpass event pages with platform-specific safety gates, screenshots, and draft/publish confirmation. |
